...
export class RoleService {
  public constructor(
    ...
    this._baseUrl = `${_settingsService.baseUrl}/Role`;
  }

  private _baseUrl: string;

  public getAllAsync(): Observable<HttpRequestResultT<Role[]>> {
    const url = `${this._baseUrl}/GetAllAsync`;
    return this._httpClient.get<HttpRequestResultT<Role[]>>(url).pipe(
      map(result => {
  ...
  public getByIdAsync(id: string): Observable<HttpRequestResultT<Role>> {
  ...
  public getDefaultRoleAsync(): Observable<HttpRequestResultT<Role>> {
    const url = `${this._baseUrl}/GetDefaultRoleAsync`;
    return this._httpClient.get<HttpRequestResultT<Role>>(url).pipe(
      map(result => {
        this.logMessages(result);
        return result;
  ...
  public insertAsync(role: Role): Observable<HttpRequestResultT<Role>> {
    const url = `${this._baseUrl}/InsertAsync`;
    return this._httpClient.post<HttpRequestResultT<Role>>(url, role, this._settingsService.httpOptionsForm).pipe(
      map(result => {
        this.logMessages(result);
        return result;
      })
  ...
  public updateAsync(role: Role): Observable<HttpRequestResultT<Role>> {
    const url = `${this._baseUrl}/UpdateAsync`;
    return this._httpClient.post<HttpRequestResultT<Role>>(url, role, this._settingsService.httpOptions).pipe(
      map(result => {
        this.logMessages(result);
        return result;
      })
  ...
  public setDefaultRoleAsync(id: string): Observable<HttpRequestResult> {
    const url = `${this._baseUrl}/SetDefaultRoleAsync?id=${id}`;
    return this._httpClient.get<HttpRequestResult>(url).pipe(
      map(result => {
        this.logMessages(result);
        return result;
